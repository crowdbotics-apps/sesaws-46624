"""
Django settings for sesaws_46624 project.
...
ROOT_URLCONF = 'sesaws_46624.urls'
...
WSGI_APPLICATION = 'sesaws_46624.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sesaws_46624 API",
    "DESCRIPTION": "API documentation for sesaws_46624 App",
    "VERSION": "v1",
}
